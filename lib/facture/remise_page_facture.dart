...
class RemisePageFacture extends StatefulWidget {

  @override
  RemisePageFactureState createState() => RemisePageFactureState();

}

class RemisePageFactureState extends State<RemisePageFacture> {
            ...
            IconButton(
              ...
              onPressed: () {
                ...
                if (_formKey.currentState!.validate() == true) {
                  ...
                  print(provFacture.typeremise);
                  provFacture.typeremise = provRemise.nomRemise;
                  print(provFacture.typeremise);
                  if(provFacture.typeremise == 'Aucune remise'){

                    provFacture.remise = 0 ;
                  ...
                  else
                  {
                    ...
                    if(provFacture.typeremise == 'Remise sur total'){
                      ...
                      provFacture.poucentageRemise = provRemise.pourcentage;
                    }

                    else {
                      if(provFacture.typeremise == 'Montant fixe'){

                        provFacture.remise = provRemise.montantFixe;
                      }
