...
class ModifierArticleDevis extends StatefulWidget {
String id='';

ModifierArticleDevis(this.id);

  @override
  ModifierArticleDevisState createState() => ModifierArticleDevisState();
}

class ModifierArticleDevisState extends State<ModifierArticleDevis> {
  ...
  Widget build(BuildContext context) {
    ...
    if(test == false)
      {
        art.tva=provDevis.listArticle[provDevis.existArticleInDivis(widget.id)].keys.first.tva;
        DescriptionController.text= provDevis.listArticle[provDevis.existArticleInDivis(widget.id)].keys.first.description;
        prixController.text= provDevis.listArticle[provDevis.existArticleInDivis(widget.id)].keys.first.prix.toString();
        quantityController.text= provDevis.listArticle[provDevis.existArticleInDivis(widget.id)].values.first.toString();
        pourcentageController.text= provDevis.listArticle[provDevis.existArticleInDivis(widget.id)].keys.first.poucentageTva.toString();
      }
                ...
                builder: (BuildContext context) => AlertDialog(
                  ...
                  actions: <Widget>[
                    TextButton(
                      ...
                      provDevis.deleteArticleFromDevis(provDevis.existArticleInDivis(widget.id)) ;
            ...
            onPressed: () {
              if (_formKey.currentState!.validate() == true) {
                _formKey.currentState!.save();
                  ...
                  provDevis.updateArticleInListArticle({art :  quantite}, provDevis.existArticleInDivis(art.id));
